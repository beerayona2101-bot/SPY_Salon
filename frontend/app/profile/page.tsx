...
function UserProfileContent() {
  const { user, isLoading, logout, updateProfileUser } = useAuth();
      ...
      >
        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left space-y-4 sm:space-y-0 sm:space-x-6 w-full">
          ...
          <div className="relative group shrink-0">
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-3xl rosegold-gradient-bg border-2 border-rosegold-400 text-dark-900 font-extrabold text-3xl flex items-center justify-center shadow-2xl overflow-hidden">
          ...
          <div className="space-y-1.5 flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-300 flex flex-wrap justify-center sm:justify-start items-center gap-3">
              <span>{user?.email || 'vip.guest@spysalon.com'}</span>
              <span>•</span>
