  ...
  return (
    <div className="min-h-screen bg-dark-900 text-white py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 animate-fadeIn text-left">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
        <div className="flex bg-dark-800/80 light:bg-white/90 p-1 rounded-2xl border border-white/10 light:border-amber-900/20 text-xs font-semibold text-gray-400 light:text-gray-700 w-full sm:w-auto">
          <button
            ...
            className={`flex-1 sm:flex-initial px-2.5 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all flex items-center justify-center space-x-1.5 cursor-pointer whitespace-nowrap text-[11px] sm:text-xs ${
              activeTab === 'schedules' ? 'rosegold-gradient-bg !text-white font-bold shadow-md' : 'hover:text-white light:hover:text-amber-900 hover:bg-white/10 light:hover:bg-amber-100/60'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 sm:flex-initial px-2.5 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all flex items-center justify-center space-x-1.5 cursor-pointer whitespace-nowrap text-[11px] sm:text-xs ${
              activeTab === 'past-orders' ? 'rosegold-gradient-bg !text-white font-bold shadow-md' : 'hover:text-white light:hover:text-amber-900 hover:bg-white/10 light:hover:bg-amber-100/60'
            }`}
          >
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-xl bg-dark-800 light:bg-white border border-white/10 light:border-amber-900/20 text-xs text-white light:text-gray-900 placeholder-gray-500 focus:outline-none focus:border-rosegold-500 light:focus:border-amber-600"
            />
          </div>
          ...
          <select
            ...
            className="p-2 rounded-xl bg-dark-800 light:bg-white border border-white/10 light:border-amber-900/20 text-xs text-gray-300 light:text-gray-900 focus:outline-none"
          >
                  ...
                  {!isCompletedOrEnded(item.status) && (
                    <>
                      <button
                        ...
                        className="px-3.5 py-2 rounded-xl bg-dark-800 light:bg-white text-rosegold-300 light:text-amber-900 border border-rosegold-500/30 light:border-amber-900/30 hover:bg-dark-700 light:hover:bg-amber-100/60 font-bold text-xs cursor-pointer"
                      >
                        Reschedule
                      </button>
                      <button
                        onClick={() => setCancelItem(item)}
                        className="px-3.5 py-2 rounded-xl bg-red-500/15 light:bg-red-50 text-red-400 light:text-red-700 border border-red-500/30 light:border-red-300 hover:bg-red-500/25 light:hover:bg-red-100 font-bold text-xs cursor-pointer"
                      >
                        Cancel
                      </button>
                    </>
