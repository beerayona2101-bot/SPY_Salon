...
export default function ForgotPasswordPage() {
  ...
  const handleRequestOtp = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      setSuccessMessage(res.message || '6-Digit OTP code sent to your email inbox!');
      setStep(2);
    } else {
    ...
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-6 relative z-10">
        ...
        <div className="text-center space-y-3">
          <div className="w-16 h-16 rounded-full bg-white p-1 border border-rosegold-500/40 flex items-center justify-center shadow-glow-rosegold mx-auto overflow-hidden">
