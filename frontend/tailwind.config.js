  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        dark: {
          950: 'var(--color-dark-950, #060608)',
          900: 'var(--color-dark-900, #0B0B0E)',
          850: 'var(--color-dark-850, #0F0F13)',
          800: 'var(--color-dark-800, #13131A)',
          700: 'var(--color-dark-700, #1A1A24)',
          600: 'var(--color-dark-600, #252533)'
        }
      },
      boxShadow: {
